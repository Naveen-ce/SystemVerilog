...
initial begin
 ...
 data=2**0; data1=2**2;
 #10 data=2**18-2; data1=2**18-2; 
 #10 data=2**8-1; data1=2**15; 
 #10 data=2**17-1; data1=2**17-1; 
#10 $finish;
end
...
Time=10 | Data=d-2 | Data1=d65534
Time=20 | Data=d255 | Data1=d32768
Time=30 | Data=d-1 | Data1=d65535
