...
module tb;
  initial begin 
    ...
    $display("Time=%0t | Main display : Fork join is done && waiting for fork to finish",$time);
...
Time=0 | Main display : Fork join is done && waiting for fork to finish
...
Time=30 | Main display : Fork join is ended
...
module tb;
  initial begin 
    ...
    $display("Time=%0t | Main display : Fork join is done and waiting for fork to finish",$time);
...
Time=0 | Main display : Fork join is starting
Time=0 | Main display : Fork join is done and waiting for fork to finish
Time=0 | Thread_1  is printed
Time=5 | Thread_1_0  is printed
Time=5 | Thread_2  is printed
Time=10 | Thread_2_0  is printed
